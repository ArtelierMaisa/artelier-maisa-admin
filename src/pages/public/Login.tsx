...
export function Login() {
  ...
  return (
    <main className='flex flex-col w-full h-screen bg-white justify-center items-center'>
      <form className='flex flex-col w-full md:w-[40rem] h-full md:h-auto justify-center items-center px-8 pb-8 sm:px-12 sm:pb-12 md:px-20 md:pb-20 pt-3 bg-background-color rounded-none md:rounded-lg md:shadow-default'>
        <img
          src={SECONDARY_LOGO}
